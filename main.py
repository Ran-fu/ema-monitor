# main.py (整合版：15m+30m + Uptime/Robot + Top3 Daily Push)
...
if __name__ == "__main__":
    load_state()
    scheduler.start()
    send_telegram("🚀 Bitunix EMA 監控（15m+30m + Uptime + Top3）已啟動")
